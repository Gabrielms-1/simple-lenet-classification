...
estimator = PyTorch(
    ...
    base_job_name=f"cad-alzheimer-brain-classification-{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}",
     tags=[
    ...
    output_s3_uri=training_config['S3']['output_dir'],
    output_path=training_config['S3']['output_dir'] + "/final_model",
    environment={
